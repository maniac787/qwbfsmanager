...
unix:!macx {
    ...
    # desktop file (basename must match QGuiApplication::desktopFileName)
    qwbfs_desktop.path  = $${PACKAGE_PREFIX}/share/applications
    qwbfs_desktop.files = ../packages/qwbfsmanager.desktop

    # desktop icon file
    qwbfs_desktopicon.path  = $${PACKAGE_PREFIX}/share/icons/hicolor/512x512/apps
    qwbfs_desktopicon.files = $$PWD/resources/qwbfsmanager.png
    qwbfs_desktopicon256.path  = $${PACKAGE_PREFIX}/share/icons/hicolor/256x256/apps
    qwbfs_desktopicon256.files = $$PWD/resources/qwbfsmanager.png

    INSTALLS    *= qwbfs_target qwbfs_desktop qwbfs_desktopicon qwbfs_desktopicon256
}
