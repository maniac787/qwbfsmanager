...
protected:
    ...
    void isoToWBFS( WorkerThread::Task task, QWBFS::Model::Disc& source, const QString& target, bool trimWBFS, const QString& invalidChars, const QString& pattern = QString() );
    ...
    void wbfsToWBFS( WorkerThread::Task task, QWBFS::Model::Disc& source, const QString& target, bool trimWBFS, const QString& invalidChars, const QString& pattern = QString() );
    QString trimmedTargetPath( const QString& targetDir, const QWBFS::Model::Disc& source, const QString& invalidChars, const QString& pattern, const QString& suffix ) const;
    void copyFileWithProgress( const QString& sourcePath, const QString& targetPath, QWBFS::Model::Disc& result );
    int allocateFileWithProgress( const QString& filePath, qint64 size );
    void emitFileProgress( qint64 value, qint64 maximum );
    QString transferLogStamp() const;
    QString formatTransferSpeed( qint64 bytesPerSecond ) const;
    void emitStatusLog( const QString& text );
    void emitTransferLog( const QString& text );
...
signals:
    ...
    void canceled();
    void syncingChanged( bool active );
};
