...
{
    const QStringList savedPaths = mSettings->value( SETTINGS_TRANSLATIONS_PATHS ).toStringList();
    QSet<QString> translationsPaths( savedPaths.begin(), savedPaths.end() );
    ...
    return translationsPaths.values();
}
