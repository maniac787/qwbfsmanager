...
(archived). Application version in tree: `1.5.2` (`qwbfs/qwbfs.pro`).
...
[Unreleased]: https://github.com/maniac787/qwbfsmanager/compare/v1.5.2...HEAD
[1.5.2]: https://github.com/maniac787/qwbfsmanager/releases/tag/v1.5.2
